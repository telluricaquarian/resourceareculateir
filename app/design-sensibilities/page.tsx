        ...
        <div className="mt-16 text-center">
          ...
          <div className="mx-auto mt-10 max-w-3xl space-y-6 text-left text-muted-foreground">
            ...
            <p>
              ...
              internally consistent, procedurally sound, and confidently
              executed. Good design applies this insight ethically: not to
              mislead, but to remove uncertainty. When every element reinforces
              legitimacy — visual systems, copy tone, interaction timing — trust
              becomes automatic. The best interfaces don’t convince users; they
              make doubt unnecessary.
            </p>
          </div>
        </div>
      </section>
